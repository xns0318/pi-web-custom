...
export const zhTWLocale: LocalePlugin = {
  ...
  label: "繁體中文",
  messages: {
    "workspace.viewingDisk": "正在檢視磁碟檔案。編輯草稿已保留，點選「編輯」可繼續。",
    "workspace.cm.find": "尋找",
    "workspace.cm.replaceLabel": "取代為",
    "workspace.cm.next": "下一個",
    "workspace.cm.previous": "上一個",
    "workspace.cm.all": "全部符合項目",
    "workspace.cm.matchCase": "區分大小寫",
    "workspace.cm.regexp": "正規表示式",
    "workspace.cm.wholeWord": "全字比對",
    "workspace.cm.replace": "取代",
    "workspace.cm.replaceAll": "全部取代",
    "workspace.cm.close": "關閉",
    "workspace.cm.goToLine": "跳至行",
    "workspace.cm.go": "跳轉",
    "workspace.cm.currentMatch": "目前符合項目",
    "workspace.cm.onLine": "所在行",
    "workspace.cm.replacedOne": "已取代第 $ 行的符合項目",
    "workspace.cm.replacedMany": "已取代 $ 個符合項目",
    "workspace.cm.fold": "摺疊行",
    "workspace.cm.unfold": "展開行",
    "workspace.new": "新增…",
    "workspace.actions": "{name} 的操作",
    "workspace.edit": "編輯",
    "workspace.create-file": "新增檔案",
    "workspace.create-directory": "新增資料夾",
    "workspace.rename": "重新命名",
    "workspace.delete": "刪除",
    "workspace.save": "儲存",
    "workspace.saving": "儲存中…",
    "workspace.saved": "已儲存",
    "workspace.unsaved": "未儲存的修改",
    "workspace.exitEdit": "結束編輯",
    "workspace.loading": "載入中…",
    "workspace.wrongWorkspace": "草稿已保留，請切回此檔案所屬的工作區後再編輯或儲存。",
    "workspace.discard": "捨棄此檔案尚未儲存的修改？此操作無法復原。",
    "workspace.viewDisk": "檢視磁碟版本",
    "workspace.reloadDisk": "捨棄草稿並重新載入",
    "workspace.diskVersion": "目前磁碟版本（唯讀）",
    "workspace.rebase": "保留草稿，以此版本為基準",
    "workspace.rebaseConfirm": "保留你的草稿，並使用這個磁碟版本作為新基準？請先合併需要保留的修改。再次儲存會寫入你的草稿，不會自動合併兩個版本。",
    "workspace.editorFor": "編輯 {name}",
    "workspace.deleteWarning": "永久刪除此檔案？沒有資源回收筒，無法復原。",
    "workspace.deleteDirectoryWarning": "永久刪除此資料夾及全部子內容（包括隱藏檔案）？沒有資源回收筒，無法復原。",
    "workspace.typeName": "輸入資料夾名稱 {name} 以確認：",
    "workspace.confirmName": "確認資料夾名稱",
    "workspace.name": "名稱",
    "workspace.working": "處理中…",
    "workspace.permanentDelete": "永久刪除",
    "workspace.confirm": "確認",
    "workspace.error.invalidPath": "需要目前工作區內的絕對路徑。",
    "workspace.error.invalidName": "請輸入單一有效名稱，不含路徑分隔符號、控制字元或 ..，最長 255 位元組。",
    "workspace.error.protectedPath": "工作區根目錄和 Git 中繼資料受保護；包含 .git 的資料夾也不能遞迴刪除或重新命名。",
    "workspace.error.outsideWorkspace": "此操作超出了已授權的目前工作區。",
    "workspace.error.symbolicLink": "符號連結在編輯器和檔案管理中維持唯讀。",
    "workspace.error.unsupportedFile": "僅可編輯一般 UTF-8 文字檔案；二進位和特殊檔案維持唯讀。",
    "workspace.error.unsupportedEncoding": "此檔案不是有效的 UTF-8 文字，未進行修改。",
    "workspace.error.mixedNewlines": "檔案包含混合或不支援的換行符號，為避免改變格式，維持唯讀。",
    "workspace.error.tooLarge": "編輯器支援最大 1 MiB 的文字檔案，此檔案維持唯讀。",
    "workspace.error.notDirectory": "目標不是資料夾。",
    "workspace.error.changed": "磁碟版本已變更，草稿仍保留。請重新讀取、核對內容，或重新開啟檔案操作視窗後再試。",
    "workspace.error.confirmationRequired": "請依要求輸入名稱以確認刪除。",
    "workspace.error.sameName": "請使用不同的名稱。",
    "workspace.error.treeTooLarge": "此資料夾超過安全管理上限（100,000 個子項），請使用終端處理。",
    "workspace.error.invalidRequest": "檔案操作請求無效。",
    "workspace.error.notFound": "檔案或資料夾已不存在，編輯器中的草稿仍保留。",
    "workspace.error.exists": "名稱已存在，未覆寫任何既有內容。",
    "workspace.error.permission": "權限不足，請檢查檔案及所在目錄的權限。",
    "workspace.error.unsupportedOperation": "此檔案系統不支援該安全操作，未覆寫既有內容。",
    "workspace.error.busy": "檔案或目錄正忙，請等待目前操作完成後再試。",
    "workspace.error.failed": "檔案操作失敗。請保留草稿，檢查磁碟狀態後再重試。",
    "workspace.error.network": "網路異常，草稿已保留。操作可能已完成，請先檢查磁碟狀態再重試。",
    "workspace.error.pendingDraft": "請先儲存或關閉受影響的未儲存檔案，並等待儲存請求完成；不會直接捨棄草稿。",
    "usage.label": "用量",
    ...
    "usage.range.all": "全部",
    "usage.refresh": "重新整理",
    "usage.autoRefresh": "背景每 {seconds} 秒更新，關閉面板也繼續；點擊「重新整理」立即更新。",
    "usage.close": "關閉",
    "usage.loading": "載入中…",
    "usage.error": "用量載入失敗，請重試",
    "usage.stale": "目前顯示上次成功載入的資料",
    "usage.empty": "此時段尚無用量紀錄",
    "usage.total": "總 Token",
    "usage.records": "紀錄數",
    "usage.recordCount": "{count} 筆紀錄",
    "usage.cost": "估算費用",
    "usage.cache": "快取",
    "usage.date": "日期",
    "usage.model": "模型",
    "usage.project": "專案",
    "usage.searchProjects": "依專案名稱或路徑篩選",
    "usage.assistantModel": "未知模型",
    "usage.toolModel": "工具用量（未記錄模型）",
    "usage.summaryModel": "摘要 / 壓縮（未記錄模型）",
    "usage.updated": "更新於 {time} · {count} 個工作階段檔案 · {zone}",
    "usage.note": "口徑：API 回報用量，輸入包含重複傳送的上下文；總量包含快取 Token，推理已計入輸出。依瀏覽器時區的自然日彙總，近 7/30 天均包含今日。",
    "usage.coverage": "僅統計已儲存的紀錄（含工具與摘要用量），不含已刪除或未記錄的消耗。fork/clone 歷史已去重（{count} 筆副本），依工作目錄分別統計，各 worktree 不合併。費用為估算，非帳單。",
    "usage.partial": "資料可能不完整：{files} 個檔案/目錄無法讀取，{lines} 行格式或時間無效（可能仍在寫入），可重新整理後重試。",
    "common.ok": "確定",
    "common.language": "語言",
    "common.models": "模型",
    "common.skills": "技能",
    ...
    "chat.modelDetails": "模型詳情",
    "chat.selectedModelId": "所選模型 ID：{id}",
    "chat.responseModelId": "伺服器回傳 ID：{id}",
    "chat.modelIdNotRecorded": "未記錄",
    "chat.modelIdCaveat": "回傳 ID 由服務商或閘道報告，不能據此驗證底層實際模型。",
