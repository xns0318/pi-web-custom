...
export const enLocale: LocalePlugin = {
  ...
  label: "English",
  messages: {
    "workspace.viewingDisk": "Viewing the disk file. Your editor draft is retained; choose Edit to resume it.",
    "workspace.cm.find": "Find",
    "workspace.cm.replaceLabel": "Replace",
    "workspace.cm.next": "next",
    "workspace.cm.previous": "previous",
    "workspace.cm.all": "all",
    "workspace.cm.matchCase": "match case",
    "workspace.cm.regexp": "regexp",
    "workspace.cm.wholeWord": "by word",
    "workspace.cm.replace": "replace",
    "workspace.cm.replaceAll": "replace all",
    "workspace.cm.close": "close",
    "workspace.cm.goToLine": "Go to line",
    "workspace.cm.go": "go",
    "workspace.cm.currentMatch": "current match",
    "workspace.cm.onLine": "on line",
    "workspace.cm.replacedOne": "replaced match on line $",
    "workspace.cm.replacedMany": "replaced $ matches",
    "workspace.cm.fold": "Fold line",
    "workspace.cm.unfold": "Unfold line",
    "workspace.new": "New…",
    "workspace.actions": "Actions for {name}",
    "workspace.edit": "Edit",
    "workspace.create-file": "New file",
    "workspace.create-directory": "New folder",
    ...
    "workspace.exitEdit": "Exit editing",
    "workspace.loading": "Loading…",
    "workspace.wrongWorkspace": "Draft retained. Switch back to this file's workspace to edit or save it.",
    "workspace.discard": "Discard unsaved changes to this file? This cannot be undone.",
    "workspace.viewDisk": "View disk version",
    "workspace.reloadDisk": "Discard draft and reload",
    "workspace.diskVersion": "Current disk version (read-only)",
    "workspace.rebase": "Keep draft with this disk baseline",
    "workspace.rebaseConfirm": "Keep your draft and adopt this disk version as its baseline? Merge any changes you need first. Your next Save will write your draft, not automatically merge the versions.",
    "workspace.editorFor": "Edit {name}",
    "workspace.deleteWarning": "Permanently delete this file? There is no recycle bin or undo.",
    "workspace.deleteDirectoryWarning": "Permanently delete this folder and ALL its contents, including hidden files? There is no recycle bin or undo.",
    "workspace.typeName": "Type the folder name {name} to confirm:",
    "workspace.confirmName": "Confirm folder name",
    "workspace.name": "Name",
    "workspace.working": "Working…",
    "workspace.permanentDelete": "Permanently delete",
    "workspace.confirm": "Confirm",
    "workspace.error.invalidPath": "An absolute path within the current workspace is required.",
    "workspace.error.invalidName": "Enter one valid name, without path separators, control characters or .. (maximum 255 bytes).",
    "workspace.error.protectedPath": "The workspace root and Git metadata are protected. Recursive operations containing .git are also blocked.",
    "workspace.error.outsideWorkspace": "This operation is outside the authorized workspace.",
    "workspace.error.symbolicLink": "Symbolic links are read-only in the editor and file manager.",
    "workspace.error.unsupportedFile": "Only regular UTF-8 text files can be edited. Binary/special files remain read-only.",
    "workspace.error.unsupportedEncoding": "This file is not valid UTF-8 text. It was not changed.",
    "workspace.error.mixedNewlines": "Mixed or unsupported line endings: kept read-only to avoid changing file formatting.",
    "workspace.error.tooLarge": "The editor supports text files up to 1 MiB. This file remains read-only.",
    "workspace.error.notDirectory": "The target is not a directory.",
    "workspace.error.changed": "The disk version changed. Your draft is retained. Reload/review it, or reopen the file-operation dialog before retrying.",
    "workspace.error.confirmationRequired": "Confirm deletion using the required name.",
    "workspace.error.sameName": "Choose a different name.",
    "workspace.error.treeTooLarge": "This folder exceeds the safe management limit (100,000 entries). Use the terminal to manage it.",
    "workspace.error.invalidRequest": "Invalid file operation request.",
    "workspace.error.notFound": "The file or directory no longer exists. Any editor draft is retained.",
    "workspace.error.exists": "That name already exists. Nothing was overwritten.",
    "workspace.error.permission": "Permission denied. Check the file and directory permissions.",
    "workspace.error.unsupportedOperation": "This filesystem does not support this safe operation. Nothing was overwritten.",
    "workspace.error.busy": "The file or directory is busy. Try again after the current operation finishes.",
    "workspace.error.failed": "The file operation failed. Keep your draft and check the disk before retrying.",
    "workspace.error.network": "Network error. Your draft is retained. Check the disk before retrying: the operation may already have completed.",
    "workspace.error.pendingDraft": "First save or close affected unsaved files, and wait for pending saves. Drafts will not be silently discarded.",
    "usage.label": "Usage",
    ...
    "usage.autoRefresh": "Server updates every {seconds}s, even with this panel closed. Refresh updates now.",
    "usage.close": "Close",
    "usage.loading": "Loading…",
    "usage.error": "Could not load usage. Please retry",
    "usage.stale": "Showing the last successful snapshot",
    "usage.empty": "No metered usage in this range",
    ...
    "usage.searchProjects": "Filter by project name or path",
    "usage.assistantModel": "Unknown model",
    "usage.toolModel": "Tool usage (model not recorded)",
    "usage.summaryModel": "Summary / compaction (model not recorded)",
    "usage.updated": "Updated {time} · {count} session files · {zone}",
    "usage.note": "API-reported usage: input includes resubmitted context; total includes cache Token, with reasoning already in output. Ranges use calendar days in the browser time zone, including today.",
    "usage.coverage": "Stored records only (including tool/summary usage); deleted or unrecorded usage is unavailable. Fork/clone history deduplicated ({count} copies); each working directory (including each worktree) is counted separately. Cost is an estimate, not a bill.",
    "usage.partial": "Partial data: {files} unreadable files/directories, {lines} invalid lines or timestamps (possibly still being written). Refresh to retry.",
    "common.ok": "OK",
    ...
    "chat.modelDetails": "Model details",
    "chat.selectedModelId": "Selected model ID: {id}",
    "chat.responseModelId": "Server-returned ID: {id}",
    "chat.modelIdNotRecorded": "Not recorded",
    "chat.modelIdCaveat": "The returned ID is reported by the provider or gateway; it does not verify the underlying model.",
    ...
    "terminal.newIn": "New independent terminal in {cwd}",
    "terminal.numberedName": "{number}: {name}",
