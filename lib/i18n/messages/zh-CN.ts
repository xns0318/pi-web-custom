...
export const zhCNLocale: LocalePlugin = {
  ...
  label: "简体中文",
  messages: {
    "workspace.viewingDisk": "正在查看磁盘文件。编辑草稿已保留，点击“编辑”可继续。",
    "workspace.cm.find": "查找",
    "workspace.cm.replaceLabel": "替换为",
    "workspace.cm.next": "下一个",
    "workspace.cm.previous": "上一个",
    "workspace.cm.all": "全部匹配",
    "workspace.cm.matchCase": "区分大小写",
    "workspace.cm.regexp": "正则表达式",
    "workspace.cm.wholeWord": "全字匹配",
    "workspace.cm.replace": "替换",
    "workspace.cm.replaceAll": "全部替换",
    "workspace.cm.close": "关闭",
    "workspace.cm.goToLine": "跳转到行",
    "workspace.cm.go": "跳转",
    "workspace.cm.currentMatch": "当前匹配项",
    "workspace.cm.onLine": "所在行",
    "workspace.cm.replacedOne": "已替换第 $ 行的匹配项",
    "workspace.cm.replacedMany": "已替换 $ 个匹配项",
    "workspace.cm.fold": "折叠行",
    "workspace.cm.unfold": "展开行",
    "workspace.new": "新建…",
    "workspace.actions": "{name} 的操作",
    "workspace.edit": "编辑",
    "workspace.create-file": "新建文件",
    "workspace.create-directory": "新建文件夹",
    "workspace.rename": "重命名",
    "workspace.delete": "删除",
    "workspace.save": "保存",
    "workspace.saving": "保存中…",
    "workspace.saved": "已保存",
    "workspace.unsaved": "未保存的修改",
    "workspace.exitEdit": "退出编辑",
    "workspace.loading": "加载中…",
    "workspace.wrongWorkspace": "草稿已保留，请切回此文件所属的工作区后再编辑或保存。",
    "workspace.discard": "放弃此文件尚未保存的修改？此操作无法撤销。",
    "workspace.viewDisk": "查看磁盘版本",
    "workspace.reloadDisk": "放弃草稿并重新加载",
    "workspace.diskVersion": "当前磁盘版本（只读）",
    "workspace.rebase": "保留草稿，以此版本为基准",
    "workspace.rebaseConfirm": "保留你的草稿，并使用这个磁盘版本作为新基准？请先合并需要保留的修改。再次保存会写入你的草稿，不会自动合并两个版本。",
    "workspace.editorFor": "编辑 {name}",
    "workspace.deleteWarning": "永久删除此文件？没有回收站，无法撤销。",
    "workspace.deleteDirectoryWarning": "永久删除此文件夹及全部子内容（包括隐藏文件）？没有回收站，无法撤销。",
    "workspace.typeName": "输入文件夹名称 {name} 以确认：",
    "workspace.confirmName": "确认文件夹名称",
    "workspace.name": "名称",
    "workspace.working": "处理中…",
    "workspace.permanentDelete": "永久删除",
    "workspace.confirm": "确认",
    "workspace.error.invalidPath": "需要当前工作区内的绝对路径。",
    "workspace.error.invalidName": "请输入单个有效名称，不含路径分隔符、控制字符或 ..，最长 255 字节。",
    "workspace.error.protectedPath": "工作区根目录和 Git 元数据受保护；包含 .git 的文件夹也不能递归删除或重命名。",
    "workspace.error.outsideWorkspace": "此操作超出了已授权的当前工作区。",
    "workspace.error.symbolicLink": "符号链接在编辑器和文件管理中保持只读。",
    "workspace.error.unsupportedFile": "仅可编辑普通 UTF-8 文本文件；二进制和特殊文件保持只读。",
    "workspace.error.unsupportedEncoding": "此文件不是有效的 UTF-8 文本，未进行修改。",
    "workspace.error.mixedNewlines": "文件包含混合或不支持的换行符，为避免改变格式，保持只读。",
    "workspace.error.tooLarge": "编辑器支持最大 1 MiB 的文本文件，此文件保持只读。",
    "workspace.error.notDirectory": "目标不是文件夹。",
    "workspace.error.changed": "磁盘版本已变化，草稿仍保留。请重新读取、核对内容，或重新打开文件操作窗口后再试。",
    "workspace.error.confirmationRequired": "请按要求输入名称以确认删除。",
    "workspace.error.sameName": "请使用不同的名称。",
    "workspace.error.treeTooLarge": "此文件夹超过安全管理上限（100,000 个子项），请使用终端处理。",
    "workspace.error.invalidRequest": "文件操作请求无效。",
    "workspace.error.notFound": "文件或文件夹已不存在，编辑器中的草稿仍保留。",
    "workspace.error.exists": "名称已存在，未覆盖任何已有内容。",
    "workspace.error.permission": "权限不足，请检查文件及所在目录的权限。",
    "workspace.error.unsupportedOperation": "此文件系统不支持该安全操作，未覆盖已有内容。",
    "workspace.error.busy": "文件或目录正忙，请等待当前操作完成后再试。",
    "workspace.error.failed": "文件操作失败。请保留草稿，检查磁盘状态后再重试。",
    "workspace.error.network": "网络异常，草稿已保留。操作可能已完成，请先检查磁盘状态再重试。",
    "workspace.error.pendingDraft": "请先保存或关闭受影响的未保存文件，并等待保存请求完成；不会直接丢弃草稿。",
    "usage.label": "用量",
    ...
    "usage.range.all": "全部",
    "usage.refresh": "刷新",
    "usage.autoRefresh": "后台每 {seconds} 秒更新，关闭面板也继续；点击“刷新”立即更新。",
    "usage.close": "关闭",
    "usage.loading": "加载中…",
    "usage.error": "用量加载失败，请重试",
    "usage.stale": "当前显示上次成功加载的数据",
    "usage.empty": "此时段暂无用量记录",
    "usage.total": "总 Token",
    "usage.records": "记录数",
    ...
    "usage.model": "模型",
    "usage.project": "项目",
    "usage.searchProjects": "按项目名或路径筛选",
    "usage.assistantModel": "未知模型",
    "usage.toolModel": "工具用量（未记录模型）",
    "usage.summaryModel": "摘要 / 压缩（未记录模型）",
    "usage.updated": "更新于 {time} · {count} 个会话文件 · {zone}",
    "usage.note": "口径：API 上报用量，输入包含重复发送的上下文；总量包含缓存 Token，推理已计入输出。按浏览器时区的自然日聚合，近 7/30 天均包含今日。",
    "usage.coverage": "仅统计已保存的记录（含工具及摘要用量），不含已删除或未记录的消耗。fork/clone 历史已去重（{count} 条副本），按工作目录分别统计，各 worktree 不合并。费用为估算，非账单。",
    "usage.partial": "数据可能不完整：{files} 个文件/目录无法读取，{lines} 行格式或时间无效（可能仍在写入），可刷新重试。",
    "common.ok": "确定",
    "common.language": "语言",
    "common.models": "模型",
    "common.skills": "技能",
    ...
    "chat.modelDetails": "模型详情",
    "chat.selectedModelId": "所选模型 ID：{id}",
    "chat.responseModelId": "服务端返回 ID：{id}",
    "chat.modelIdNotRecorded": "未记录",
    "chat.modelIdCaveat": "返回 ID 由服务商或网关报告，不能据此验证底层实际模型。",
